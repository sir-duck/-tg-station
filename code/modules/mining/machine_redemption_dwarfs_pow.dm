...
/obj/machinery/mineral/ore_redemption/dwarfp
	...
	sheet_per_ore = 1
	point_upgrade = 1
	list/ore_values = list(("sand" = 1), ("iron" = 1), ("dmetal" = 10), ("plasma" = 15), ("silver" = 16), ("gold" = 18), ("titanium" = 30), ("uranium" = 30), ("diamond" = 50), ("bluespace crystal" = 50), ("bananium" = 60))
	speed_process = 1

/obj/machinery/mineral/ore_redemption/dwarfp/New()
	..()
	var/obj/item/weapon/circuitboard/machine/B = new /obj/item/weapon/circuitboard/machine/ore_redemption/dwarfp(null)
	B.apply_default_parts(src)

/obj/item/weapon/circuitboard/machine/ore_redemption/dwarfp
...
/obj/machinery/mineral/ore_redemption/dwarfp/RefreshParts()
...
/* /obj/machinery/mineral/ore_redemption/dwarfp/proc/process_sheet(obj/item/weapon/ore/O)
...
/obj/machinery/mineral/ore_redemption/dwarfp/process()
...
/obj/machinery/mineral/ore_redemption/dwarfp/attackby(obj/item/weapon/W, mob/user, params)
	if (!powered())
		return
...
/obj/machinery/mineral/ore_redemption/dwarfp/on_deconstruction()
	empty_content()

/*/obj/machinery/mineral/ore_redemption/dwarfp/proc/SmeltMineral(obj/item/weapon/ore/O)
	if(O.refined_type)
...
/obj/machinery/mineral/ore_redemption/dwarfp/attack_hand(mob/user)
	if(..())
		return
	interact(user)

/obj/machinery/mineral/ore_redemption/dwarfp/interact(mob/user)
...
/*/obj/machinery/mineral/ore_redemption/dwarfp/proc/get_ore_values()
...
/obj/machinery/mineral/ore_redemption/dwarfp/Topic(href, href_list)
	if(..())
		return
	if(href_list["choice"])
		if(istype(inserted_id))
...
/* /obj/machinery/mineral/ore_redemption/dwarfp/proc/empty_content()
	var/obj/item/stack/sheet/s
